...
from bike_rental.defs.assets.training.ml_ready_data import y_train_hourly, X_train_hourly, X_test_hourly, y_test_hourly
from bike_rental.defs.config.experiment_config import ExperimentConfigResource
from bike_rental.defs.resources.config_resource import ConfigResource
...
from bike_rental.defs.assets.training.test_train_split import train_dataset_hourly, train_dataset_hourly_by_location, test_dataset_hourly, test_dataset_hourly_by_location
from bike_rental.defs.assets.training.ml_ready_by_location import X_train_hourly_by_location, y_train_hourly_by_location, X_test_hourly_by_location, y_test_hourly_by_location
...
defs = Definitions(
    ...
    resources={
            ...
            "loader": DataLoader(),
            "config": ConfigResource("src/bike_rental/defs/config/ml_config.yml"),
            "experiment_config":
